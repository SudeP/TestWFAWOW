...
public class OutputCacheSpecAttribute : ActionFilterAttribute, IExceptionFilter
{
    ...
    public OutputCacheSpecAttribute()
    {

    }

    internal OutputCacheSpecAttribute(ObjectCache childActionCache)
    {
    ...
    internal string GetChildActionUniqueId(ActionExecutingContext filterContext)
    {
        ...
        uniqueIdBuilder.Append(CreateUniqueId(VaryByCustom));
    ...
    private static string GetUniqueIdFromActionParameters(ActionExecutingContext filterContext, IEnumerable<string> keys)
    {
        ...
        return CreateUniqueId(keys.Concat(keys.Select(key => keyValues.ContainsKey(key) ? keyValues[key] : null)));
    }
    ...
    public static string CreateUniqueId(IEnumerable<object> parts)
    {
        ...
        foreach (object part in parts)
        {
            ...
            if (part != null)
            {
                ...
                if (type != null)
                {
                    var prop = type.GetProperty("UniqueId", BindingFlags.NonPublic);
                    if (prop != null)
                    {
                        AppendPartToUniqueIdBuilder(builder, prop.GetValue(part));
                        continue;
                    }
                }
            }
